    ...
    <section id="home" className="py-16 sm:py-24">
      ...
      <div className="container mx-auto px-4">
        ...
        <div 
          ref={trialSectionRef} 
          id="trial"
          className="mt-16 text-center !scroll-smooth" 
          ...
          <div className="max-w-4xl mx-auto grid grid-cols-2 gap-2 sm:gap-8">            
            ...
            <Card className="shadow-lg border-2 border-primary/20 relative overflow-hidden">              
              ...
              <CardContent className="p-2 sm:p-4 text-center">
                <Image src={hasEgg ? "/images/meals/mix.png" : "/images/non-egg/MIX veg.png"} alt={`Mixed ${hasEgg ? 'Egg' : 'Veg'} Meal - Trial Offer`} data-ai-hint="trial meal box" width={150} height={112} className="rounded-lg mb-2 mx-auto" />
                ...
                <CardContent className="p-4 sm:p-6">
                  <div className="grid grid-cols-2 gap-4 items-center">
                    ...
                    <div className="w-full col-span-1">
                      <Image src="/images/non-egg/MIX veg.png" alt="Mixed Sprout Salad" width={400} height={300} className="rounded-lg object-cover aspect-[4/3] shadow-lg" />
                    </div>
                  </div>
                </CardContent>
              </Card>
...
<JuiceSelectionModal
  ...
  planType={'trial'}
  juicePrice={selectedTrial === 'navaratri' ? 99 : 49} // Navaratri is the combo; price is doubled inside the modal via isCombo
